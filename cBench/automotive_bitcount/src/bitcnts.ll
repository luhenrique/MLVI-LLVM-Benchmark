...
declare dso_local i32 @ntbl_bitcnt(i64) #1

declare dso_local i32 @ntbl_bitcount(i64) #1

declare dso_local i32 @BW_btbl_bitcount(i64) #1

declare dso_local i32 @AR_btbl_bitcount(i64) #1
